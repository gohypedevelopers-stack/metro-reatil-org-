...
const PortfolioSection = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      category: "Commercial",
      title: "Neon Tech Hub",
      desc: "Innovative open workspaces designed for collaborative excellence.",
    ...
    },
    {
      ...
      desc: "Executive suites featuring acoustic precision and premium materials.",
      img: "https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=2069&auto=format&fit=crop",
    },
    // Residential
    {
      ...
      desc: "Minimalist luxury living focusing on light, space, and bespoke joinery.",
    ...
    },
    {
      ...
      desc: "Panoramic city views complemented by rich, tactile interior textures.",
    ...
    },
    {
      ...
      category: "Residential",
      title: "Oasis Estate",
      desc: "A sanctuary of tranquility blending modern architecture with organic elements.",
    ...
    },
    {
      id: "f02",
      category: "F&B",
      title: "Noir Brasserie",
      desc: "Moody atmospheres and dramatic lighting for an unforgettable dining experience.",
    ...
    },
    {
      ...
      category: "F&B",
      title: "Lumina Cafe",
      desc: "Bright, airy aesthetic with bespoke culinary display installations.",
      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12">
        ...
        >
          <AnimatePresence mode="popLayout">
            {(activeFilter === 'All' ? projects.filter((p, index, self) => index === self.findIndex(t => t.category === p.category)) : projects.filter(p => p.category === activeFilter)).map((project, index) => (
              <motion.div
                layout
                key={project.id}
