        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-12">
          <div className="max-w-3xl">
            <motion.span
              ...
              className="text-brand-gold text-[10px] font-bold uppercase tracking-[0.5em] mb-6 block"
            >
              Our Solutions
            </motion.span>
            <motion.h1
        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-12 relative z-10">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-16">
            <div className="text-center lg:text-left max-w-2xl">
              <span className="text-brand-gold text-[10px] font-bold uppercase tracking-[0.5em] mb-6 block">Production Excellence</span>
              <h3 className="text-4xl font-serif text-white mb-6">In-House Manufacturing Facility</h3>
