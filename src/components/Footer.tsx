          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-6">
              <li className="flex items-start gap-4 group">
                ...
                <span className="text-neutral-400 text-[11px] font-bold uppercase tracking-widest leading-relaxed group-hover:text-brand-dark transition-colors">XYZ Location, <br />India</span>
              </li>
              <li className="flex items-center gap-4 group">
                <Phone size={16} className="text-brand-gold shrink-0" />
                <span className="text-neutral-400 text-[11px] font-bold uppercase tracking-widest group-hover:text-brand-dark transition-colors">+91 XXXXX XXXXX</span>
              </li>
            </ul>
          </div>
