      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12">
        <div className="grid lg:grid-cols-2 gap-14 lg:gap-24 items-center">
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            <h2 className="mobile-heading-balance text-center lg:text-left text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-serif text-brand-dark mb-8 md:mb-10 uppercase leading-tight w-full" style={{ fontFamily: 'var(--font-cinzel), serif' }}>
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-6">
            ...
            <div className="pt-0 md:pt-12 space-y-4 md:space-y-6">
