...
const AboutSection = () => {
  return (
    <section id="about" className="py-20 md:py-32 bg-[#FAFAFA] text-brand-dark relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-5 lg:col-start-2 relative z-10 flex flex-col items-center text-center lg:items-start lg:text-left">
            <div className="inline-flex items-center gap-4 mb-8">
              ...
              <span className="text-brand-gold uppercase tracking-[0.3em] text-xs font-bold">The Foundation</span>
            </div>
            
            <h2 className="mobile-heading-balance text-center lg:text-left text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-serif text-brand-dark mb-10 uppercase leading-tight w-full" style={{ fontFamily: 'var(--font-cinzel), serif' }}>
              EXECUTING <br />
            ...
            <p className="text-xl text-neutral-800 mb-8 leading-relaxed font-light">
